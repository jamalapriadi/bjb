<div>
    <nav class="navbar navbar-bottom navbar-copyright" role="navigation">
    <div class="container">
    ...
    <!-- app -->
  <script src="<?php echo base_url('assets/app/controllers/frontCtrl.js');?>"></script>
    <script src="<?php echo base_url('assets/app/services/frontService.js');?>"></script>
    <script src="<?php echo base_url('assets/app/front.js');?>"></script>
    <!-- end app-->
</body>
</html>